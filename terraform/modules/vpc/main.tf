...
# Subnets Privés (pour EKS worker nodes)
...
# Route Tables Privées (une par AZ pour HA)
...
# Associations Route Table <-> Subnets Privés
...
# Associations Route Table <-> Subnets Database
...
# Security Group par défaut pour le VPC
